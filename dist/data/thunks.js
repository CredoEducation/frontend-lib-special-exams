...
function startProctoredExam() {
  return /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(dispatch, getState) {
      var exam, _ref6, attempt, _ref7, workerUrl, useWorker, startExamTimeoutMilliseconds;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 5:
              ...
              (0, _handlers.workerPromiseForEventNames)(_constants2.default.start, exam.attempt.desktop_application_js_url)(startExamTimeoutMilliseconds).then(function () {
...
function stopExam() {
  return /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(dispatch, getState) {
      var _getState$examState, exam, activeAttempt, attemptId, examUrl, res;
      ...
      return regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 17:
              _context8.next = 19;
              return (0, _api.updateAttemptStatus)(attemptId, 'check_questions_completed');
            ...
            case 25:
              if (!window.confirm("You have not completed ".concat(res.unanswered_count, " of ").concat(res.problems_count, " questions in the exam. Are you sure you want to end your exam?"))) {
                _context8.next = 28;
                break;
              }
...
function getExamReviewPolicy() {
  return /*#__PURE__*/function () {
    var _ref20 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(dispatch, getState) {
      var exam, data;
