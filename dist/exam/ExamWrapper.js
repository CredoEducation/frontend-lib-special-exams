...
var ExamWrapper = function ExamWrapper(_ref) {
  ...
  var isGated = sequence && sequence.gatedContent !== undefined && sequence.gatedContent.gated; // if the user is browsing public content (not logged in) they cannot be in an exam
